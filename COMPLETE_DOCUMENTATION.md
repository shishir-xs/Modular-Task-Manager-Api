...
4. [Admin Frontend Setup](#4-admin-frontend-setup)
5. [Admin Route Registration Flow](#5-admin-route-registration-flow)
6. [Implementation Summary](#6-implementation-summary)
7. [WordPress Asset Handle Explanation](#7-wordpress-asset-handle-explanation)
...
## 5. Admin Route Registration Flow
